...
def get_ran_px():
    ...
    print("Random Pixel BGR Value", pixel_value)
    return pixel_value


@app.get("/random_number_generator")
def random_number_generator():
    """
    Returns a random number from a random pixel value

    from a Youtube livestream of jellyfish tank

    """

    return {"Random Number": get_ran_px()}
